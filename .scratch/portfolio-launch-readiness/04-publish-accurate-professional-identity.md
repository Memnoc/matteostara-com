# 04 — Publish the accurate professional identity

**Spec:** `docs/specs/2026-08-13-portfolio-launch-readiness.md`

**What to build:** A visitor sees one consistent account of Matteo's current
seniority, professional specialty, personal technical direction, and Applied
AI study across Home and About, without an employer disclosure or an implied
formal AI research role.
